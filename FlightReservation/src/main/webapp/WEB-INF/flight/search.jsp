...
<body>
	<header class="d-flex bd-highlight mb-3">
		...
		<div class="btn btn-secondary ms-auto p-2 bd-highlight">Sign In</div>
		...
		<div class="d-flex justify-content-evenly btn-group">
			...
			<button type="button" class="btn btn-lg btn-secondary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false">
				...
				<ul class="dropdown-menu">
					<li><a class="dropdown-item" href="#">SEA</a></li>
					<li><a class="dropdown-item" href="#">PDX</a></li>
					<li><a class="dropdown-item" href="#">BOI</a></li>
					<li><a class="dropdown-item" href="#">PSC</a></li>
				</ul>
				
	<!--Bootstrap Arrow  -->		
			<svg xmlns="http://www.w3.org/2000/svg" width="48" height="36" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
