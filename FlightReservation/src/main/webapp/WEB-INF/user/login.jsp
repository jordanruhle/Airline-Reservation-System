...
<body>
	...
	<div class="mainContent d-flex align-items-center justify-content-center">
		<div class="regForm bg-light p-3">
			<form:form action="/login" class="container-sm" method="POST" modelAttribute="newLogin">
			<h2>Login!</h2>
				<div class="row">
				...
				<div class="d-flex justify-content-center pt-3">
					<button class=" form-label btn btn-warning btn-lg ms-2">Login</button>
				</div>
			</form:form>
				<div class="d-flex flex-column align-items-center pt-3 gap-3">
					<h2>Don't have an account?</h2>
					<form:form action="/register" method="GET">
						<button class=" form-label btn btn-warning btn-lg ms-2">Sign up!</button>
					</form:form>
				</div>
		</div>
	</div>
